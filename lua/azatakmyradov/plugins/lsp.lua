    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
            ...
            callback = function(event)
                ...
                map('<leader>D', require('telescope.builtin').lsp_type_definitions, '[G]oto [D]efinitions')

                -- Search the docs
                map('<leader>sh', require('telescope.builtin').help_tags, '[H]elp [T]ags')
                map('gl', ":lua vim.diagnostic.open_float()<CR>", '[G]oto [L]ine')
